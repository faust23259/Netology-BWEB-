...
<body>
	<h1>Домашние задания BWEB-Netology</h1>
	<table class="table">
		<tr class="row">
			<th class="row-title">
				<p>HTTP и современный Web. Формы и форматы передачи данных</p>
			</th>
			<td class="row-value">
				<a href="https://n.mishin.vekprom.ru/homework-1-http/form.php">Домашнее задание №1</a>
			</td>
			<td class="row-value">
		...
		<tr class="row">
			...
			<td class="row-value">
				<a href="https://github.com/faust23259/Netology-BWEB-/commit/75b76e66d04d4bfb6d0fb0ed831938fb7b1fcf9d">GitHub</a>
			</td>
		</tr>
		<tr class="row">
			<th class="row-title">
